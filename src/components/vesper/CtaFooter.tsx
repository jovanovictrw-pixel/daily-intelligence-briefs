        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          >
            <input
              ...
              className="flex-1 px-4 py-3 bg-card border border-divider rounded-sm font-body text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
            />
            <button
              type="submit"
              className="px-6 py-3 bg-primary text-primary-foreground font-body text-sm font-semibold rounded-sm hover:bg-primary/90 transition-colors whitespace-nowrap"
            >
              Request Access
            </button>
          </form>
